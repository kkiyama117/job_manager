# This file is partially generated by pyo3_stub_gen. The return-type
# annotations for async pyfunctions (submit_flow, walk_flows) are hand-
# patched because stub_gen cannot yet infer the concrete Coroutine yield
# type. If the stubs are regenerated, re-apply those edits.
...
class FlowRun:
    ...
    def read(root: builtins.str | os.PathLike | pathlib.Path, flow_uuid: builtins.str) -> FlowRun:
        ...
        Raises:
            ValueError: when `flow_uuid` is not a valid UUID string.
            RuntimeError: when any of the required TOML files cannot be read or parsed.
        """
        ...
...
def submit_flow(root: builtins.str | os.PathLike | pathlib.Path, flow_uuid: builtins.str, dry_run: builtins.bool = False) -> typing.Coroutine[typing.Any, typing.Any, builtins.dict[builtins.str, builtins.int]]:
    r"""
    Submit a flow. Returns a coroutine that resolves to `dict[JobId, slurm_jobid]`.
...
def walk_flows(root: builtins.str | os.PathLike | pathlib.Path) -> typing.Coroutine[typing.Any, typing.Any, builtins.list[typing.Any]]:
    r"""
    Walk all flow.toml under `root`. Returns a coroutine that resolves to a
    list of items (each either a parsed flow object or a tuple `(None, str)`
